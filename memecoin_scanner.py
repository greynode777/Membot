    ...
    while True:
        ...
        for res in results:
            ...
            if score >= CONFIG["min_score_to_alert"]:
                ...
                send_telegram_alert(mint, res["dexdata"], res["rugcheck"], score, deductions, t.get("sources", []), age_hours, t.get("score_history"), dev_balance)
                t["recommended"] = True
            ...
            if baseline and baseline > 0:
                ...
                for tier in sorted(CONFIG["post_rec_dev_alert_tiers"], reverse=True):
                    if sold_pct >= tier and tier > already_alerted:
                        ...
                        send_dev_dump_alert(mint, name_for_alert, symbol_for_alert, sold_pct, baseline, current_balance)
